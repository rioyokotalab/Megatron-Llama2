...
# model config
HF_CHECKPOINT_DIR=/bb/llm/gaf51275/jalm/Llama-2-13b-chat-merged-tokenizer-hf
MEGATRON_CHECKPOINT_DIR=/bb/llm/gaf51275/llama/llama-megatron-convert-checkpoint-hf/Llama-2-13b
