...
#$ -l h_rt=28:00:00:00
#$ -j y
#$ -o outputs/llama-2-70b-base/16node/
#$ -cwd
...
PIPELINE_PARALLEL_SIZE=4 # num layers 80: Llama-2 70B
...
CHECKPOINT_SAVE_DIR=/bb/llm/gaf51275/llama/checkpoints/llama-2-70b-base-megatron/16node/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}
