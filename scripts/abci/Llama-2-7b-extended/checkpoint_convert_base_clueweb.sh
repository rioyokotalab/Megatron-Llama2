...
# model config
HF_CHECKPOINT_DIR=/bb/llm/gaf51275/jalm/modified-llama2-base-tokenizer-nfkc-aligned-8/llama2-7b-base-merged-tokenizer-nfkc-16k-hf
MEGATRON_CHECKPOINT_DIR=/bb/llm/gaf51275/llama/llama-megatron-convert-checkpoint-hf/Llama-2-7b-extended/clueweb/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}
