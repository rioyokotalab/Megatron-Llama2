...
# model config
BASE_CHECKPOINT_DIR=/bb/llm/gaf51275/llama/checkpoints/Llama-2-7b-base-extended/okazaki_lab_cc-en-updated/tp2-pp2
TARGET_CHECKPOINT_DIR=/bb/llm/gaf51275/llama/from_megatron_hf_checkpoints/megatron_checkpoints/Llama2-7b-base-extended-en-updated/okazaki_lab_cc/tp${TARGET_TENSOR_PARALLEL_SIZE}-pp${TARGET_PIPELINE_PARALLEL_SIZE}
