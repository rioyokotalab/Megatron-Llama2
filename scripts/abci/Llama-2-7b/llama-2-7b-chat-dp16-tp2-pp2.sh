...
CHECKPOINT_SAVE_DIR=/bb/llm/gaf51275/llama/checkpoints/llama-2-7b-chat-megatron/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-test

mkdir -p ${CHECKPOINT_SAVE_DIR}

# data config
DATASET_DIR=/bb/llm/gaf51275/llama/datasets/okazaki_lab_cc_600_default
